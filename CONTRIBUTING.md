...
- Raise an issue found via [GitHub Issues](https://github.com/ARMmbed/mbed-tools-lib/issues).
- Open an [pull request](https://github.com/ARMmbed/mbed-tools-lib/pulls) to:
  - Provide a fix.
